        ...
        <div className="flex items-center gap-4">
          <div className="flex flex-col text-base text-[#767676] relative">
            ...
            >
              ...
              <option value="Clock" selected={searchTerm === "Clock"}>
                Wall Clock
              </option>
              <option value="Toran" selected={searchTerm === "Toran"}>
                Toran
              </option>
              <option value="Bajoth" selected={searchTerm === "Bajoth"}>
                Bajoth
              </option>
            </select>
          </div>
      ...
      {endOffset > 0 && (
        <div className="flex flex-col mdl:flex-row justify-center mdl:justify-between items-center">
          ...
          <p className="text-base font-normal text-lightText">
            Products from {endOffset > 0 ? itemStart : 0} to {endOffset} of{" "}
